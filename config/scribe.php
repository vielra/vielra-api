...
return [
    ...
    // The base URL displayed in the docs. If this is empty,
    // Scribe will use the value of config('app.url') at generation time.
    // If you're using `laravel` type, you can set this to a
    // dynamic string, like '{{ config("app.tenant_url") }}' to get a dynamic base URL.
    'base_url' => null,
    ...
    'laravel' => [
        ...
        // By default, `/docs` opens the HTML page, `/docs.postman`
        // opens the Postman collection, and `/docs.openapi` the OpenAPI spec.
        'docs_url' => '/api/docs',
    ...
    // will be used in the displayed docs, generated examples and response calls.
    'auth' => [
        // Set this to true if ANY endpoints in your API use authentication.
        'enabled' => true,

        // Set this to true if your API should be authenticated by default. If so,
        // you must also set `enabled` (above) to true.
        // You can then use @unauthenticated or @authenticated on
        // individual endpoints to change their status from the default.
        'default' => true,
