                    ...
                    ">
                      ...
                      ">
                        <a class="o_text-primary" href="{{ env(" APP_FRONT_END_URL") }}" style="
                          ...
                          color: #126de5;
                      ">
                          <img src="{{ URL::to('/assets/mails/logo-primary-vertical-lookup.png') }}" width="100"
                            height="26" alt="{{ config('app.name')}}" style="
                              max-width: 100px;
                            ...
                            ">
                              ...
                              ">
                                <span style="
                                                                            ...
                                                                            color: #82899a;
                                                                        ">{{ $data['email'] }}</span>
                                <img src="{{ URL::to('/assets/mails/person-24-light.png') }}" width="24" height="24"
                                  alt="" style="
                                                                            max-width: 24px;
                                                                            -ms-interpolation-mode: bicubic;
                                                                            vertical-align: middle;
              ...
              <tr>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td rowspan="2" class="o_sans o_text o_text-secondary o_px o_py" align="center" style="
                            ...
                            padding-bottom: 16px;
                        ">
                          <img src="{{ URL::to('/assets/mails/vpn_key-48-primary.png') }}" width="48" height="48" alt=""
                            style="
                              max-width: 48px;
                              -ms-interpolation-mode: bicubic;
                              vertical-align: middle;
                ...
                ">We heard you need a password reset.</p>
                  <p style="
                    ...
                    font-size: 19px;
                    line-height: 27px;
                  ">Here is your OTP code</p>
                  <h2 class="o_text-dark o_mb-xxs" style="
                    font-weight: bold;
                    margin-top: 0px;
                    margin-bottom: 4px;
                    color: #242b3d;
            ...
            <tbody>
              ...
              ">
                  <p style="
                    margin-top: 0px;
                    margin-bottom: 0px;
                  ">If you didn’t request this email, you can safely ignore it. Your password
                    won’t be changed.</p>
                </td>
              </tr>
            </tbody>
                    ...
                    ">
                      ...
                      ">
                        <a class="o_text-light" href="{{ env('APP_FRONT_END_URL') }}" style="
                            ...
                            color: #82899a;
                        ">
                          <img src="{{ URL::to('/assets/mails/facebook-light.png') }}" width="36" height="36" alt="fb"
                            style="
                              max-width: 36px;
                              -ms-interpolation-mode: bicubic;
                              vertical-align: middle;
                        ...
                        <a class="o_text-light" href="{{ env('APP_FRONT_END_URL') }}" style="
                            ...
                            color: #82899a;
                        ">
                          <img src="{{ URL::to('/assets/mails/twitter-light.png') }}" width="36" height="36" alt="tw"
                            style="
                                max-width: 36px;
                                -ms-interpolation-mode: bicubic;
                                vertical-align: middle;
                        ...
                        <a class="o_text-light" href="{{ env('APP_FRONT_END_URL') }}" style="
                            ...
                            color: #82899a;
                        ">
                          <img src="{{ URL::to('/assets/mails/instagram-light.png') }}" width="36" height="36" alt="ig"
                            style="
                              max-width: 36px;
                              -ms-interpolation-mode: bicubic;
                              vertical-align: middle;
